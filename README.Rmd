...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/teproj)](https://cran.r-project.org/package=teproj)
[![packageversion](https://img.shields.io/badge/Package%20version-0.0.1.1-orange.svg?style=flat-square)](commits/master)
...
badgecreatr::badgeplacer(status = "wip", githubaccount = "tonyelhabr", githubrepo = "teproj")
```
...
__NOTE:__ The following are no longer exported.
...
a .Rmd file. [^r2rmd] __NOTE:__ These functions are fairly experimental and
